(The ProxyToys website is a plain plagiate of Joe Walnes' XStream website, the
XStream website is modelled on the jMock.org website though, created by Nat Pryce).
...
3) Run the site builder from the parent ProxyToys directory using Ant:

   % ant website

   The new site will be deployed in ./build/website.

4) TODO: To deploy the site, commit your changes to CVS.  The continuous integration system
   will build the site and deploy it onto proxytoys.codehaus.org
