...
public class CglibNullTest extends ProxyTestCase {
    ...
    public void testShouldBeAbleToInstantiateClassWithPrimitiveParametersInConstructor() {
        ...
        for (int i = 0; i < 10; i++) {
            ClassWithPrimitiveParametersInConstructor o = (ClassWithPrimitiveParametersInConstructor) Null.object(ClassWithPrimitiveParametersInConstructor.class, FACTORY);
            assertNotNull(o);
        }
    }
