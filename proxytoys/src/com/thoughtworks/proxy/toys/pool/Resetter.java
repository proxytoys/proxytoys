...
public interface Resetter {
    /**
     * Reset the pooled object. The implementation may do anything to reset the state of the pooled element. If the element is
     * definately exhausted, a return value of <code>false</code> prevents the element from returning into the pool and the
