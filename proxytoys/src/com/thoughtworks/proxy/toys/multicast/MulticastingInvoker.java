...
/**
 * A {@link Invoker} implementation that multicasts calls to multiple targets. Proxies generated by this class will forward all
 * method invocations to an array of underlying objects. The behaviour is recursive, so return values will also be multicasting
 * objects.
 * 
